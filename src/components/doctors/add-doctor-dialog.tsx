  ...
  return (
    ...
    <>
      ...
      <Button
        ...
        className="h-12 rounded-2xl bg-gradient-to-r from-indigo-600 to-violet-600 px-6 font-medium text-white shadow-lg shadow-indigo-500/20 transition-all duration-300 hover:scale-[1.02] hover:from-indigo-500 hover:to-violet-500"
      >
      ...
      >
        ...
        <DialogContent className="max-w-2xl border-white/10 bg-zinc-950 text-white shadow-2xl">
